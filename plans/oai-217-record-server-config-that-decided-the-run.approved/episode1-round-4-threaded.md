...
New: `scripts/lib/run-context.mjs` (leaf: `attachRunContext`, `serverConfigFrom`), `tests/run-context.test.js`.
Edited:
...
F8; `effectiveWindow` unchanged, its signature and conflict-only `.detected` confirmed at 245-288).
