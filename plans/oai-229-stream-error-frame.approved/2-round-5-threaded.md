...
`failure-shape.mjs`'s module note names the new constant as the one refusal kept there; and, outside
the code, `BACKLOG.md`'s OAI-229 body is annotated with the landed detection site and
`evidence/013.md` records the post-fix live re-run;
