 ...
 */
function disqualified(verdicts, calibrationCleared) {
 ...
 */
export function summarize(verdicts, { calibrationCleared = true, minSlackMs = null } = {}) {
  const blocked = disqualified(verdicts, calibrationCleared);
